...
namespace Edis.Repositories
{
    public class TranzakcioAdatkontextus
    {
        ...
        {
            return $"SzemelyzetId:{SzemelyzetId},RogzitoIntezetId:{RogzitoTelephelyId},RogzitoSzemelySid:{RogzitoSzemelySid},RogzitoSzemelyNev:{RogzitoSzemelyNev},RogzitoSzemelyLoginNev:{RogzitoSzemelyLoginNev}";
        }
    }
}
